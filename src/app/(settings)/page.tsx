...
const features = [
	...
	},
	{
		...
		description: "Instantly translate dialogues to understand nuances and expand vocabulary.",
	},
	{
		icon: <BrainCircuit className="h-6 w-6" />,
		title: "Customizable Practice",
		description: "Select topics, languages, and difficulty levels to suit your learning goals.",
	},
];
					...
					<div className="lg:grid lg:grid-cols-12 lg:gap-8">
						<div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
							<h1 className="text-4xl font-bold text-primary tracking-tight sm:text-5xl md:text-6xl">
								...
								<span className="block text-destructive">Through AI-Powered Dialogues</span>
							</h1>
							<p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
								Choose your topic, language, and difficulty level to practice communication skills like never
								before.
							</p>
				...
				<div className="container mx-auto px-4">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-10">
						<div className="text-center">
							...
							<p>Select the topic, language, and difficulty level for your dialogue.</p>
						</div>
						<div className="text-center">
							<div className="bg-destructive text-white w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center text-2xl">
								2
							</div>
							<h4 className="text-2xl font-bold mb-4">Engage in Conversations</h4>
							<p>Practice with AI-generated dialogues designed to simulate real interactions.</p>
						</div>
						<div className="text-center">
							<div className="bg-destructive text-white w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center text-2xl">
								3
							...
							<p>Generate translations and refine your skills with instant feedback.</p>
						</div>
					</div>
				</div>
			</section>
